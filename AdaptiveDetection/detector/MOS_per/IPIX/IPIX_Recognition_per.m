...
%     index_t1 = ceil(rand()*(M-10000))+2000;
    ...
    x0=a*p+x0;%+pp;    %%%%%%%  重要  %%%%%%%%%%%%%
    %%%%%MOS%%%%%%%%%%%%
    s_H1 = -abs(fun_s_H1_per([Train,x0],p,2));
    s_H2 = -abs(fun_s_H2_per([Train,x0],p,2));
    s_H3 = -abs(fun_s_H3_per([Train,x0],p,2));
    %%%%ABIC%%%%%%%%%%%%%%
...
grid on
box on
str=['IPIX_per_Rang_',num2str(Range),'_',num2str(offset)];
save(str);
