...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%复合高斯0.1,5dB%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(log10(PFA),Pd_ECC_Mlti_mc(:,4),'r-*','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_PCC_Mlti_mc(:,4),'g-*','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_LogCC_Mlti_mc(:,4),'b-*','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_E_Mlti_mc(:,4),'r-.','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_P_Mlti_mc(:,4),'g-.','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_LogM_Mlti_mc(:,4),'b-.','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_CC_Mlti_mc(:,4),'k-*','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_SFP_Mlti_mc(:,4),'c-*','linewidth',linewide1,'markersize',mkft)
plot(log10(PFA),Pd_R_Mlti_mc(:,4),'m-.*','linewidth',linewide1,'markersize',mkft)
...
plot(log10(PFA),Pd_R_Mlti_mc(:,3),'m-.*','linewidth',linewide1,'markersize',mkft)
