...
h_leg = legend...
       ...
       '\lambda=1, 1S-GLRT with SCM ','\lambda=1, 1S-GLRT with NSCM ','\lambda=1, 1S-GLRT with SFPE ',...
       '\lambda=3, GLC-GLRT',        '\lambda=3, 1S-GLRT with CC ',...
       '\lambda=3, 1S-GLRT with SCM ','\lambda=3, 1S-GLRT with NSCM ','\lambda=3, 1S-GLRT with SFPE ',...
       '\lambda=5, GLC-GLRT',        '\lambda=5, 1S-GLRT with CC ',...
       '\lambda=5, 1S-GLRT with SCM ','\lambda=5, 1S-GLRT with NSCM ','\lambda=5, 1S-GLRT with SFPE ');
xlabel('SNR/dB','FontSize',labeltsize,'FontWeight',fw,'FontName',fn)
ylabel('Pd','FontSize',labeltsize,'FontWeight',fw,'FontName',fn)
set(gca,'FontSize',labeltsize,'FontWeight',fw,'FontName',fn)
set(gcf,'Position',[700 0 1200 1000])
