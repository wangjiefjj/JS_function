...
figure
hold on
plot(ft,(10*log10(PSD_CC/max(PSD_CC))),'c-');
plot(ft,(10*log10(PSD_ML/max(PSD_ML))),'r-.');
plot(ft,(10*log10(PSD_NSCM/max(PSD_NSCM))),'g-.');
plot(ft,(10*log10(PSD_ECC/max(PSD_ECC))),'g-');
plot(ft,(10*log10(PSD_LogM/max(PSD_LogM))),'b-');
plot(ft,(10*log10(PSD_LogCC/max(PSD_LogCC))),'b-.');
plot(ft,(10*log10(PSD_P/max(PSD_P))),'m-');
plot(ft,(10*log10(PSD_PCC/max(PSD_PCC))),'m-.');
grid on
