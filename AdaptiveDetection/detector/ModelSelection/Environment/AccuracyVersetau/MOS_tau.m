...
for i_tau = 1:length(tau)
    ...
    Accuracy_AIC1(i_tau) = count_AIC1/MC;
    Accuracy_GIC1(i_tau) = count_GIC1/MC;
    Accuracy_AICc1(i_tau) = count_AICc1/MC;
    Accuracy_ABIC1(i_tau) = count_ABIC1/MC;

    Accuracy_AIC2(i_tau) = count_AIC2/MC;
    Accuracy_GIC2(i_tau) = count_GIC2/MC;
    Accuracy_AICc2(i_tau) = count_AICc2/MC;
    Accuracy_ABIC2(i_tau) = count_ABIC2/MC;
    
    Accuracy_AIC3(i_tau) = count_AIC3/MC;
    Accuracy_GIC3(i_tau) = count_GIC3/MC;
    Accuracy_AICc3(i_tau) = count_AICc3/MC;
    Accuracy_ABIC3(i_tau) = count_ABIC3/MC;
end
toc
close(h)
% figure(1)
