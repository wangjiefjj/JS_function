%% Figure 64. SINR loss for element space pre-Doppler. Zero intrinsic cluller motion.
%
%
...
%% Beamformer G Matrix Construction for Displaced Filter Beamspace post-Doppler
%% STAP with Two Step Nulling (TSN):
Ks = 3;
...
LSINRTSNdf   = SINRTSNdf/SNRo;
     ...
     figure('NumberTitle', 'off','Name', ... 
                'Figure 64(a) SINR loss for example system, â=1, no misalinment, no intrinsic clutter motion');
