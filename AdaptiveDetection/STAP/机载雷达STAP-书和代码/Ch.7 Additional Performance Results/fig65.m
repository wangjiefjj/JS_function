%% Figure 65.(a) SINR loss for example system, â=2.6, no misalinment, no intrinsic cluller motion.
%
%
...
LSINRpostTSN = SINR30/SNRo;
  ...
  %% Plot the SINR Losses:
     figure('NumberTitle', 'off','Name', ... 
                'Figure 65(a) SINR loss for example system, â=2.6, no misalinment, no intrinsic clutter motion');
     ...
     legend('Optimum Fully Adaptive','Elem-Pre (54)','Elem-Post (54)',...
                  'Beam-Pre TSN (9)','Beam-Post TSN (9)',...
