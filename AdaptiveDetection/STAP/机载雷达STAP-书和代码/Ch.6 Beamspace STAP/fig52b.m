%% Figure 52 (b). Displaced-beam (db) and Adjacent-beam (ab) pre-Doppler STAP performance
%% with ambiguous clutter (â=3) and no jamming.
%
...
% Platform Parameters:
beta = 3;                        % beta parameter > 1 signifies Doppler ambiguous clutter.
ha = 9000;                     % in meters.
...
LSINR30ab   = SINR30ab/SNRo;
     ...
     figure('NumberTitle', 'off','Name', ... 
         ['Figure 52. (b) Displaced-beam pre-Doppler STAP performance with doppler-ambiguous clutter (â = ',num2str(beta),') and no jamming.']);
