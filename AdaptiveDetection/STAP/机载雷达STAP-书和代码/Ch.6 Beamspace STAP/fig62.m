%% Figure 62. Beamspace post-Doppler in a clutter-plus-jamming environment. K = 9. Ks = Kt = 3.
...
Lr = 2;                          % System Losses on Receive in dB.
fr = 300;                       % PRF in Hz
Tr = 1/fr;                       % PRI in sec.
...
Ta = 78.4;                         % Antenna & Receiving Transmission Line Input Noise Temperature in Kelvin.
Ts = Ta + 10^(Lr/10)*Te; % Reception System Noise Temperature in Kelvin.
Nn = k*Ts;                         % Receiver Noise PSD in Watts/Hz.
Pn = Nn*B;                        % Receiver Noise Power in Watts 
...
LSINRTSNdf   = SINRTSNdf/SNRo;
  ...
  %% Plot the SINR Losses:
     figure('NumberTitle', 'off','Name', ...
             'Figure 62. Beamspace post-Doppler in a clutter-plus-jamming environment. K=9, Ksm = Ktm = 3.');
