%% Figure 52 (a). Displaced-beam (db) and Adjacent-beam (ab) pre-Doppler STAP performance
%% with ambiguous clutter (â=2) and no jamming.
%
...
% Platform Parameters:
beta = 2;                        % beta parameter > 1 signifies Doppler ambiguous clutter.
ha = 9000;                     % in meters.
...
%% Displaced Beams pre-Doppler Calculations:
...
LSINR30ab   = SINR30ab/SNRo;
     ...
     figure('NumberTitle', 'off','Name', ... 
         ['Figure 52. (a) Displaced-beam pre-Doppler STAP performance with doppler-ambiguous clutter (â = ',num2str(beta),') and no jamming.']);
