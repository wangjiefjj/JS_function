%% Figure 63. Beamspace post-Doppler in a clutter-plus-jamming environment. K = 16. Ks = Kt = 4.
...
Kt =  4;                                        % sub-CPI length (fixed). 
Ks = 4;                                        % sub-apperture length or number of beams used. 
...
LSINRTSNdf   = SINRTSNdf/SNRo;
  ...
  %% Plot the SINR Losses:
     figure('NumberTitle', 'off','Name', 'Figure 63. Beamspace post-Doppler in a clutter-plus-jamming environment. K=16, Ksm = Ktm = 4.');
