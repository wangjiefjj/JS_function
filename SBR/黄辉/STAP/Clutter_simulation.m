...
signal_parameter.pulse_num=2;           %脉冲数
...
natenna_parameter.arry_col_num=4;                     %阵元列数
natenna_parameter.Wq_azimuth_db=35;          %行加权（db）
natenna_parameter.arry_row_num=4;                     %阵元行数
